...
public class MovieService {
  ...
  public SendMessage searchLogic(Message message) {
    return this.searchLogic(message.getText(), message.getChatId());
  }
  ...
  public SendMessage searchLogic(String movieName, Long chatId) {
    ...
    return sendListMoviesSearch(movieName, chatId);
  }
  ...
  public SendMessage sendListMoviesSearch(String movieName, Long chatId) {
    List<Movie> movies;
    movies = parserService.getListMoviesBySearch(movieName);
